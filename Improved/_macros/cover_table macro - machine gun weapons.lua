function each_file(rgd)
	if rgd.GameData and rgd.GameData.weapon_bag then
		...
		bag.cover_table.tp_heavy.damage_multiplier = 0.6
		bag.cover_table.tp_heavy.penetration_multiplier = 1
		bag.cover_table.tp_heavy.suppression_multiplier = 0.3
		
		bag.cover_table.tp_light.accuracy_multiplier = 0.85
		bag.cover_table.tp_light.damage_multiplier = 0.85
		bag.cover_table.tp_light.penetration_multiplier = 1
		bag.cover_table.tp_light.suppression_multiplier = 0.7
		
		bag.cover_table.tp_negative.accuracy_multiplier = 1.1
		bag.cover_table.tp_negative.damage_multiplier = 1.1
		bag.cover_table.tp_negative.penetration_multiplier = 1
		bag.cover_table.tp_negative.suppression_multiplier = 1.2
